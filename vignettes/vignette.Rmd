...
Estimated $\beta_G$ and $\beta_{GT}$ can be found in `s3_results[['beta']][['beta_g']]` and `s3_results[['beta']][['beta_gt']]`.

```{r}
cat("Estimated beta_G:", "\n")
head(s3_results[['beta']][['beta_g']])

cat("Estimated beta_GT:", "\n")
head(s3_results[['beta']][['beta_gt']])
```
